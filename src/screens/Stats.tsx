...
const Stats = () => {
  ...
  return (
    ...
    >
      <header className="sticky top-0 z-50 flex items-center justify-between px-4 pb-4 bg-primary/5 border-b border-primary/20 backdrop-blur-md" style={{ paddingTop: `calc(env(safe-area-inset-top) + 16px)` }}>
