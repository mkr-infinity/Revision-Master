...
const MockTests = () => {
  ...
  if (testState === "generate") {
    return (
      <div className="min-h-screen font-display text-slate-900 dark:text-slate-100 flex flex-col pb-24">
        <header className="px-4 pb-4 border-b border-primary/10 flex items-center justify-between sticky top-0 glass z-50" style={{ paddingTop: `calc(env(safe-area-inset-top) + 16px)` }}>
  ...
  if (testState === "testing" && currentTest) {
    ...
    return (
      <div className="min-h-screen font-display text-slate-900 dark:text-slate-100 flex flex-col">
        <header className="px-4 pb-4 border-b border-primary/10 flex items-center justify-between glass sticky top-0 z-50" style={{ paddingTop: `calc(env(safe-area-inset-top) + 16px)` }}>
  ...
  return (
    ...
    >
      <header className="sticky top-0 z-50 glass px-4 pb-4 flex items-center justify-between border-b border-primary/10" style={{ paddingTop: `calc(env(safe-area-inset-top) + 16px)` }}>
