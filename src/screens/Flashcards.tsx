    ...
    <>
      <header className="p-4 pt-6 sticky top-0 z-50 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="size-10 rounded-xl overflow-hidden shadow-lg shadow-primary/20 border border-primary/20">
      ...
      <main className="flex-1 px-4 py-6">
        ...
        <div className="grid grid-cols-1 gap-4">
          <motion.button 
            ...
            className="group relative overflow-hidden bg-primary/5 border-2 border-dashed border-primary/20 rounded-2xl p-4 flex flex-col items-center justify-center gap-3 hover:bg-primary/10 hover:border-primary/40 transition-all"
          >
          ...
          {state.decks
            ...
            return (
              <motion.div 
                ...
                className={`group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-all cursor-pointer ${!isCustomGradient ? deck.gradient : ''}`}
                ...
                <div className="relative p-4 flex flex-col h-full text-white">
                  <div className="flex justify-between items-start mb-4">
                    <div className="size-12 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center text-white shadow-inner">
                      {activeTab === 'flashcards' ? <Layers size={24} /> : <FunctionSquare size={24} />}
                    </div>
                    <button 
                      onClick={(e) => {
                        e.stopPropagation();
                  ...
                  <h3 className="text-2xl font-bold mb-1 drop-shadow-md">{deck.name}</h3>
                  <div className="flex items-center justify-between mt-auto">
                    <p className="text-sm font-medium opacity-90 uppercase tracking-wider">
                      {deck.cards.length} {deck.cards.length === 1 ? 'Card' : 'Cards'}
                    </p>
                    {deck.isPinned && <Pin size={16} className="fill-white opacity-80" />}
                  </div>
                      ...
                      >
                        <div className="flex gap-2 pt-4 border-t border-white/20">
                          <motion.button 
                            ...
                            className="flex-1 flex items-center justify-center gap-2 py-2 rounded-xl bg-white/20 hover:bg-white/30 backdrop-blur-md transition-colors text-sm font-bold"
                          >
                            <Pin size={16} fill={deck.isPinned ? "currentColor" : "none"} /> {deck.isPinned ? 'Unpin' : 'Pin'}
                          </motion.button>
                          <motion.button 
                            whileTap={{ scale: 0.95 }}
                          ...
                          <motion.button 
                            ...
                            className="flex-1 flex items-center justify-center gap-2 py-2 rounded-xl bg-red-500/40 hover:bg-red-500/60 backdrop-blur-md transition-colors text-sm font-bold"
                          >
      ...
      {studyCard && (
        ...
        >
          <motion.div 
            ...
            className="bg-background-light dark:bg-background-dark border border-primary/20 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl flex flex-col h-[85vh] max-h-[750px]"
          >
                ...
                {isStudyComplete ? (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-400">You've reviewed all cards in this deck.</p>
                    </div>
            ...
            {!isStudyComplete && (
              <div className="p-4 border-t border-primary/10 flex gap-3">
                <motion.button 
                  ...
                  className="flex-1 py-3 rounded-xl font-bold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 flex items-center justify-center gap-2 text-sm border border-slate-200 dark:border-slate-700"
                >
      ...
      {modalType !== "none" && (
        ...
        >
          <motion.div 
            ...
            animate={{ scale: 1, opacity: 1, y: 0 }}
            exit={{ scale: 0.9, opacity: 0, y: 20 }}
            className="bg-background-light dark:bg-background-dark border border-primary/20 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl"
          >
            <div className="flex items-center justify-between p-4 border-b border-primary/10">
