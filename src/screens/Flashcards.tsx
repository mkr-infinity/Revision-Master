...
const Flashcards = () => {
  ...
  const mainContent = selectedDeck ? (() => {
    ...
    return (
      <>
        <header
          className="px-4 pb-4 sticky top-0 z-50 glass border-b border-primary/10"
          ...
          {state.decks
            ...
            return (
              <motion.div 
                ...
                className={`group relative overflow-hidden rounded-2xl shadow-md hover:shadow-lg ring-1 ring-black/5 dark:ring-white/5 transition-all cursor-pointer flex flex-col ${!isCustomGradient ? deck.gradient : ''}`}
                style={{ 
              ...
              >
                ...
                <div className={`absolute inset-0 ${deck.coverImage ? 'bg-gradient-to-t from-black/85 via-black/40 to-black/20' : 'bg-gradient-to-br from-white/10 to-black/15 group-hover:from-white/15 group-hover:to-black/10'} transition-colors`}></div>
