...
const CURRENT_VERSION = "2.0.2"; // Current app version
      ...
      {isVisible && updateInfo && (
        <div className="fixed inset-0 z-[200] flex items-start sm:items-center justify-center p-4 bg-black/60 backdrop-blur-sm" style={{ paddingTop: "calc(env(safe-area-inset-top, 0px) + 16px)", paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 16px)" }}>
          ...
          >
            ...
            <div className="p-6">
              <div className="mb-6 max-h-48 overflow-y-auto no-scrollbar prose prose-sm dark:prose-invert max-w-none
                prose-headings:font-bold prose-headings:text-slate-800 dark:prose-headings:text-slate-200 prose-headings:mt-2 prose-headings:mb-1
                prose-h1:text-base prose-h2:text-sm prose-h3:text-xs
                prose-p:text-slate-700 dark:prose-p:text-slate-400 prose-p:my-1 prose-p:leading-relaxed
                prose-ul:my-1 prose-ul:pl-4 prose-li:text-slate-700 dark:prose-li:text-slate-400 prose-li:my-0.5
